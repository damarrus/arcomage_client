...
var SrvAnswer = ds_map_find_value(async_load, "buffer"); //Считываем ответ в переменную
var BufferString = buffer_read(SrvAnswer, buffer_string); //Конвертируем ответ в строку
...
{
    //show_message(ds_map_find_value(global.JSmap, "messageType"));
